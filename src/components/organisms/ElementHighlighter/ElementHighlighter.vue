...
function getNamedTopSize(
  ...
  if (position === "center") {
    return `${
      scrollY - scrollBarCorrection + (viewHeight - rect.height - padding) / 2
    }px`;
  }
...
function updateStyles({
  ...
  // get container position adjustment if needed
  ...
  if (typeof rect.top === "string") {
    ...
    bottomStyle.height = `${page.height - rect.top - rect.height - padding}px`;
  }
